	...
	public void Login_Button() 
	{
		...
		try {
			...
			logInfo=test.createNode(new GherkinKeyword("Given"), "User should open the browser");
				...
				//Open the browser
				System.setProperty("webdriver.chrome.driver", "C:\\Users\\ruchi\\eclipse-workspace\\OrgAdmin\\drivers\\chromedriver.exe");
				driver=new ChromeDriver(options);
				driver.get("https://org-app.regalpayone.com");
   ...
   public void click_LoginButton() 
   {
	...
	public void verify_Homepage() throws Throwable
	{
		...
		try {
			...
			logInfo=test.createNode(new GherkinKeyword("And"), "Verify user is on Home Page");
